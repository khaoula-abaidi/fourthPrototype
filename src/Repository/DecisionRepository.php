...
class DecisionRepository extends ServiceEntityRepository
{
    ...
    /**
     * A function that returns All decisions not taken
    ...
    /**
     * A function returns the decicion's of contributor.id = $id
     * @param $id
     * @return Decision[] returns an array of Decision Object
     */
    public function findNotTakenOne($id){
        return$this->createQueryBuilder('d')
            ->where('d.content = false')
